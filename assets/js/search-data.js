...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-our-paper-eliciting-intrinsic-hallucinations-in-llms-via-semantically-equivalent-adversarial-attacks-has-been-accepted-at-colm-2026",
          title: 'Our paper Eliciting Intrinsic Hallucinations in LLMs via Semantically Equivalent Adversarial Attacks has...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%61%74%72%69%76%69%76%65%6B%73%68%61%72%6D%61@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/atriviveksharma", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/atri-sharma", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=Kziv62UAAAAJ&hl", "_blank");
        },
      },{
      id: 'light-theme',
